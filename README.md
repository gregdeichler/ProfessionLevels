...
- Easy-to-use interface for profession management
...
2. Access the profession tracking interface through your addons menu or commands
3. Monitor your profession levels as you level them up
...
- World of Warcraft client (compatible with Turtle WoW versions)
